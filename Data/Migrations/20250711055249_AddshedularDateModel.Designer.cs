...
namespace HealthCare_API.Migrations
{
    ...
    [Migration("20250711055249_AddshedularDateModel")]
    partial class AddshedularDateModel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HealthCareData.Identity.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("HealthCareData.Identity.Case", b =>
                {
            ...
            modelBuilder.Entity("HealthCareData.Identity.Disease", b =>
                {
                    b.Property<int>("CaseId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HealthCareData.Identity.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("HealthCareData.Identity.schedulerDate", b =>
                {
                    b.HasOne("HealthCareData.Identity.Disease", "Disease")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("HealthCareData.Identity.ApplicationUser", null)
                        .WithMany()
